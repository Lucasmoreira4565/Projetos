...
export default function TimeSlots({
  ...
  return (
    <div className="sm:w-lg bg-[#121212] border border-zinc-800 rounded-2xl p-6 sm:p-8 shadow-2xl flex flex-col items-center justify-center mx-auto transition-all duration-300">
